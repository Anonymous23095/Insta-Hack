#!/bin/bash
# FB by: https://www.youtube.com/channel/UCllBUPwO-gDNs1_X5jLjDTw
# Instagram: @programmer.launda
...
printf "\e[1;92m _  | | https://www.youtube.com/channel/UCllBUPwO-gDNs1_X5jLjDTw    \e[0m\n"
printf "\e[1;92m( \ | | ____    ___  _| |_  _____           \e[0m\n"
printf "\e[1;92m ) )| ||  _ \  /___)(_   _)(____ |  Anurag Choudhary  \e[0m\n"
printf "\e[1;77m(_/ | || | | ||___ |  | |_ / ___ |  _____   \e[0m\n"
printf "\e[1;77m    |_||_| |_|(___/    \__)\_____| (_____)  \e[0m\n"
printf "\n"
printf "\e[1;77m\e[45m   Instagram Brute Forcer v1.5 Author: programmer.launda (Github/IG)   \e[0m\n"
printf "\n"
}
